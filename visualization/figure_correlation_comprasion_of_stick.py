...
plt.plot(x_, list_correlation_o_[8], marker = 'o',markerfacecolor = 'w', linewidth = 1, \
         ...
         color = 'b')
plt.plot(x_, list_correlation_o_[13], marker = 's',markerfacecolor = 'w', linewidth = 1, \
...
plt.savefig('correlation of orintation comprasion 1.svg', dpi=600, format='svg')
plt.show()
...
plt.plot(x_, list_correlation_s_[8], marker = 'o',markerfacecolor = 'w', linewidth = 1, \
         label = 'Time = %d ms ' % ConSV_PlateBottomBeadMiddle_.loc[index1_,'Time'] + ', larger effective stiffness', \
         color = 'b')
plt.plot(x_, list_correlation_s_[13], marker = 's',markerfacecolor = 'w', linewidth = 1, \
         label = 'Time = %d ms ' % ConSV_PlateBottomBeadMiddle_.loc[index2_,'Time'] + ', smaller effective stiffness', \
         color = 'g')
plt.ylim(-0.6,1.1)
plt.axhline(0, linestyle = '--', color = 'r',linewidth = 1)
...
plt.tick_params(labelsize = 15)
plt.legend( frameon = False, fontsize = 12) 
plt.savefig('correlation of speed comprasion 1.svg', dpi=600, format='svg')
plt.show()