# -*- coding: utf-8 -*-
"""
Created on Wed Jul 20 15:00:07 2022
...
# plt.title('Small slip, time = %.2f ms ' % ConSV_PlateBottomBeadMiddle_.loc[index_,'Time'], fontsize = 23)
...
plt.savefig('scatter plot of vx small slip(max min is plate motion).svg', dpi=600, format='svg')
plt.show()
...
plt.savefig('scatter plot of vx small slip(extend range).svg', dpi=600, format='svg')
plt.show()
...
plt.savefig('scatter plot of v small slip.svg', dpi=600, format='svg')
plt.show()