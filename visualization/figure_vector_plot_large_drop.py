# -*- coding: utf-8 -*-
"""
Created on Tue Jul 19 14:07:31 2022
...
plt.title('Large slip, time = %d ms ' % ConSV_PlateBottomBeadMiddle_.loc[index_,'Time'], fontsize = 20)

plt.tight_layout()
plt.savefig('vector_largedrop.svg', dpi=600, format='svg')
plt.show()
